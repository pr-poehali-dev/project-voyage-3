...
const services = [
  ...
  },
  {
    ...
    description:
      "Дополнительная услуга: шумоизоляция колёсных арок значительно снижает уровень шума от дороги и дополнительно защищает кузов от механических повреждений.",
  },
  {
    icon: Camera,
    title: "Фотоотчёт",
